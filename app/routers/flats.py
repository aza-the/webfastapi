...
from app.schemas.flat_form_post import FlatForm
...
@router.post('/flats/')
async def get_flats_page(request: Request, form_data: FlatForm = Depends(), db: Session = Depends(get_db)):
    ...
    _dict = {
        ...
        'undergorund_station' : form_data.undergorund_station,
        'undergorund_time' : form_data.undergorund_time,
        'undergorund_get_type' : form_data.undergorund_get_type,
        'num_of_rooms' : form_data.num_of_rooms,
        'flat_size' : form_data.flat_size,
        'kitchen_size' : form_data.kitchen_size,
        'storey' : form_data.storey,
        'storeys' : form_data.storeys,
        'construction_date' : form_data.construction_date,
